 ...
 function CustomFormSubmitPost(e) {
     ...
     el.attr('disabled', true).text("منتظر بمانید").append('<div class="spinner-border" role="status"><span class="visually-hidden">Loading...</span></div>');
 };
 function CustomFormSubmitResponse(e) {
     var el = $(e);
     el.attr('disabled', false).text(temp_button_text);
 };
         ...
         form.submit(function(event){
             ...
             $.ajax({
                 ...
                 success: function(json){
                     ...
                     var resp = json["data"]
                     $('.ans').remove();
                     $('.result').append("<div class='ans' dir='rtl'>"+resp+"</div>");
